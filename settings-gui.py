...
main = Tk()
main.title('iBloxx GUI Settings')
...
#Main class
class iBloxxSettings(tk.Tk):

    def __init__(self, *args, **kwargs):

        tk.Tk.__init__(self, *args, **kwargs)
        tk.Tk.wm_title(self, "iBloxx Configuration Settings")
...
class Graph_Page(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        label = ttk.Label(self, text="iBloxx ETH/LTC", font="Verdana 15 bold")
